...
function createOutro(definition) {
	...
	var imports = definition.imports.map(getImportKeyValuePair);
...
function es6(definition) {
	...
	var beforeScript = [importBlock, dependencyBlock, 'var component = { exports: {} };'].join('\n');

	var code = [beforeScript, definition.script, outro, 'export default Ractive.extend( component.exports );'].join('\n');

	var map = options.sourceMap ? generateSourceMap(definition, {
